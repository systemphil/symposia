                                ...
                                </li>
                                {
                                    sessionData && sessionData.user.role === "ADMIN" && (
                                        <>
                                            ...
                                            <li>
                                                <Link href="/admin" className="text-purple-700">Admin</Link>
                                            </li>
                                            <li>
                                                <Link href="/test" className="text-red-500">Test</Link>
                                            </li>
                                        </>
                                    )
                                }
                            ...
                            sessionData && sessionData.user.role === "ADMIN" && (
                                <>
                                    <span className="text-purple-700">
                                        <NavBarLinkDesktop href="/admin" text="Admin" />
                                    </span>
                                    <span className="text-red-500">
                                        <NavBarLinkDesktop href="/test" text="Test" />
                                    </span>
                                </>
                            )
                        }
            ...
            <label tabIndex={0} className="btn btn-ghost btn-circle">
                <div className="avatar">
                    <div className="w-12 rounded-full">
                        ...
                        <img 
                            src={sessionData?.user.image ?? "/static/images/avatar_placeholder.png"} 
                            alt="avatar_picture" 
                        />
                    </div>
                </div>
